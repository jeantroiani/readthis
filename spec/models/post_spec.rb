...
RSpec.describe Post, :type => :model do
	...
	describe 'post' do
		...
		before(:each) { @category = Category.create(tags: 'science') }
		
		it 'can be sorted by likes, hottest will go on top' do
			@post_1 = Post.create(title: 'Hello World', created_at: '2014-09-03 20:41:30.488817', category_id: @category.id)
			@post_2 = Post.create(title: 'Hello Moon', 	created_at: '2014-09-03 20:41:30.488817', category_id: @category.id)
			@post_3 = Post.create(title: 'Hello Marth',	created_at: '2014-09-01 20:41:30.488817', category_id: @category.id)
      ...
      expect(Post.sort_by_hotness).to eq([@post_3,@post_2,@post_1])
		...
		it 'can be sorted by recently created' do
			...
			@post_1 = Post.create(title: 'Hello World', created_at: '2014-09-03 20:41:30.488817', category_id: @category.id)
			@post_2 = Post.create(title: 'Hello Moon', category_id: @category.id)
		...
		it 'will not show posts older than 24hr in the newer page'  do
			...
			@post_1 = Post.create(title: 'Hello World', created_at: '2014-09-03 20:41:30.488817', category_id: @category.id)
			@post_2 = Post.create(title: 'Hello Moon' , created_at: '2012-10-03 20:41:30.488817', category_id: @category.id)
